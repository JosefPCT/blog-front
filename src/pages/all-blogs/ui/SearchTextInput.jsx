...
export default function SearchTextInput( {onChangeInputHandler, onBlurHandler, onKeyUpHandler, userInput, }){
  return(
    <div className={styles.searchContainer}>
        ...
        <input type="text" name="userInput" id="userInput" onChange={onChangeInputHandler} onBlur={onBlurHandler} onKeyUp={onKeyUpHandler} value={userInput} className={styles.searchBox}/>
    </div>
  )
}